...
for (p in participants) {
  ...
  met_6 <- eval_metrics_eccm_cortical_rpe(init_phi_6, p_data$Resp, p_data$F, p_data$RT, p_data$delta_t)
  met_19 <- eval_metrics_eccm_golgi_asym_reversal(init_phi_19, p_data$Resp, p_data$F, p_data$RT, p_data$delta_t)
