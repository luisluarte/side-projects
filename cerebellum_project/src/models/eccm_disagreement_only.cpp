...
// [[Rcpp::export]]
inline double eval_eccm_disagreement_only(const std::vector<double>& phi, const IntegerVector& resp, const IntegerVector& out, const NumericVector& rt, const NumericVector& delta_t) {
