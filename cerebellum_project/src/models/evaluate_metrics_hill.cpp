...
// [[Rcpp::export]]
List eval_metrics_eccm_hill(const std::vector<double>& phi, const IntegerVector& resp, const IntegerVector& out, const NumericVector& rt, const NumericVector& delta_t) {
    ...
    double hill_n = 1.0 + std::exp(phi[8]);
