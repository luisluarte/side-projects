...
// ==============================================================================
// 7-DIMENSIONAL EMPIRICAL SENSORY EFFERENCE RESERVOIR ENGINE
// u_t = [Resp_{t-1}, Out_{t-1}, d_curr, d_diff, Delta_t, RT_{t-1}, TTF_{t-1}]^T
// ==============================================================================
...
// [[Rcpp::export]]
List run_empirical_gamma_reservoir_cpp(
  ...
  // 7-dimensional empirical sensory input fan-in
  int mossy_fan_in = 7;
  ...
  for (int t = 0; t < N_t; ++t) {
    ...
    // Normalized empirical sensory inputs
