...
// ==============================================================================
// HIGH-DIMENSIONAL RESERVOIR FOR DUAL KINEMATIC READOUT COMPETITION
// Exports granular state matrix Z_GC, spatial entropy S_t, and autoregressive baseline RT_base
// ==============================================================================
...
// [[Rcpp::export]]
List run_dual_readout_reservoir_cpp(
  ...
  // Sparse indexing for Mossy -> Granule (fan-in = 4)
  int mossy_fan_in = 4;
