...
cat("Compiling M009 Urgency...\n")
mod_m009 <- cmdstan_model("/home/DCCS5/cerebellum_project/src/stan/m009_urgency.stan", cpp_options = list("CXXFLAGS" = "-O3 -march=native -mtune=native -DEIGEN_NO_DEBUG -fno-math-errno"))
cat("Fitting M009 Urgency...\n")
fit_m009 <- mod_m009$sample(data = stan_data, chains = 4, parallel_chains = 4, iter_warmup = 300, iter_sampling = 300, init = 0, adapt_delta = 0.95, step_size = 0.05, max_treedepth = 10, refresh = 1)
fit_m009$save_object("/home/DCCS5/cerebellum_project/results/m009_urgency.rds")
cat("DONE\n")