...
// [[Rcpp::export]]
List eval_metrics_eccm_golgi_explore(const std::vector<double>& phi, const IntegerVector& resp, const IntegerVector& out, const NumericVector& rt, const NumericVector& delta_t) {
    ...
    double mf_threshold = std::exp(phi[9]);
