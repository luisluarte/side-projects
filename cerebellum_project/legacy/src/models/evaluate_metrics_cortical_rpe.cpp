...
// [[Rcpp::export]]
List eval_metrics_eccm_cortical_rpe(const std::vector<double>& phi, const IntegerVector& resp, const IntegerVector& out, const NumericVector& rt, const NumericVector& delta_t) {
