...
model {
  ...
  sigma_beta_session ~ cauchy(0, 1);
  sigma_kappa_session ~ cauchy(0, 1);
  sigma_tau_session ~ cauchy(0, 1);
  sigma_beta_trait ~ cauchy(0, 1);
  sigma_kappa_trait ~ cauchy(0, 1);
  sigma_tau_trait ~ cauchy(0, 1);
